...
@section('style')
    ...
    <link href="{{ asset('dash-assets/assets/css/apps/mailing-chat.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="chat-system">
                ...
                <div class="chat-box">
                    ...
                    <div class="overlay-phone-call">
                        <div class="">
                            ...
                            <div class="calling-user-img">
                                <div class="">
                                    <img src="{{ asset('dash-assets/assets/img/90x90.jpg')}}" alt="dynamic-image">
                                </div>
                    ...
                    <div class="overlay-video-call">
                        <img src="{{ asset('dash-assets/assets/img/175x115.jpg')}}" class="video-caller" alt="video-chat">
                        <div class="">
                            <div class="calling-user-info">
                                <div class="d-flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left-circle go-back-chat"><circle cx="12" cy="12" r="10"></circle><polyline points="12 8 8 12 12 16"></polyline><line x1="16" y1="12" x2="8" y2="12"></line></svg>
                    ...
                    <div class="chat-box-inner">
                        <div class="chat-meta-user">
                            <div class="current-chat-user-name"><span><img src="dash-assets/assets/img/90x90.jpg" alt="dynamic-image"><span class="name"></span></span></div>
                        ...
                        <div class="chat-conversation-box">
                            <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                                @include('inc.chat_comps.conversations')
                            </div>
                        </div>
...
@section('script')
    <script src="{{ asset('dash-assets/assets/js/apps/mailbox-chat.js') }}"></script>
@endsection
